...
int main(int argc, char **argv)
{
    ...
    sem1 = mmap(0, sizeof(sem_t), PROT_WRITE | PROT_READ, MAP_SHARED, shmid_sem1, 0);
    sem_init(sem1, 1, 0);
    ...
    sem2 = mmap(0, sizeof(sem_t), PROT_WRITE | PROT_READ, MAP_SHARED, shmid_sem2, 0);
    sem_init(sem2, 1, 0);
    ...
    sem3 = mmap(0, sizeof(sem_t), PROT_WRITE | PROT_READ, MAP_SHARED, shmid_sem3, 0);
    sem_init(sem3, 1, 1);
